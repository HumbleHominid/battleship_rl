...
## Corpus Check
- 35 files · ~11,262 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 593 nodes · 940 edges · 29 communities (22 shown, 7 thin omitted)
- Extraction: 78% EXTRACTED · 22% INFERRED · 0% AMBIGUOUS · INFERRED: 205 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b51d98ec`
...
Cohesion: 0.05
Nodes (33): BayesianAgent, Bayesian probability density agent.      Enumerates all valid ship placements on, FeatureExtractor, Return shape (4,) float32 global context vector., Computes per-cell (100, 16) and global (4,) features for the TransformerPPO agen, Record the outcome of a shot and propagate to the internal Bayesian model., Return shape (100, 16) float32 feature array for all cells.          Calls Bayes, load() (+25 more)
...
Cohesion: 0.07
Nodes (11): ABC, BaseAgent, Place this agent's fleet. Defaults to GameBoard.place_fleet()., Called after each move. Hook for training feedback; no-op by default., Reset agent state for a new episode., RandomAgent, AppLogger, GameLogger (+3 more)
...
- **Why does `GameLogger` connect `Community 2` to `Community 1`, `Community 3`, `Community 6`, `Community 7`, `Community 10`, `Community 14`?**
  _High betweenness centrality (0.238) - this node is a cross-community bridge._
- **Why does `BayesianAgent` connect `Community 1` to `Community 2`, `Community 7`?**
  _High betweenness centrality (0.158) - this node is a cross-community bridge._
- **Why does `GameLogger` connect `Community 8` to `Community 0`, `Community 3`, `Community 4`, `Community 5`, `Community 11`, `Community 12`, `Community 15`?**
