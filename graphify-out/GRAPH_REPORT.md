...
## Corpus Check
- 35 files · ~11,278 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 596 nodes · 955 edges · 29 communities (22 shown, 7 thin omitted)
- Extraction: 78% EXTRACTED · 22% INFERRED · 0% AMBIGUOUS · INFERRED: 212 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cd3e82b6`
...
10. `GameWebSocketServer` - 16 edges
...
Cohesion: 0.08
Nodes (10): ABC, BaseAgent, Place this agent's fleet. Defaults to GameBoard.place_fleet()., Called after each move. Hook for training feedback; no-op by default., Reset agent state for a new episode., load(), Battleship agent backed by a Transformer actor-critic network.      Operates in, TransformerPPOAgent (+2 more)
...
- **Why does `GameLogger` connect `Community 3` to `Community 0`, `Community 4`, `Community 7`, `Community 9`, `Community 10`, `Community 13`, `Community 15`?**
  _High betweenness centrality (0.237) - this node is a cross-community bridge._
- **Why does `BayesianAgent` connect `Community 0` to `Community 9`, `Community 3`?**
  _High betweenness centrality (0.157) - this node is a cross-community bridge._
- **Why does `BayesianAgent` connect `Community 1` to `Community 9`, `Community 6`?**
