# Graph Report - battleship-rl  (2026-05-23)

## Corpus Check
- 31 files · ~11,249 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 779 nodes · 1211 edges · 48 communities (41 shown, 7 thin omitted)
- Extraction: 79% EXTRACTED · 21% INFERRED · 0% AMBIGUOUS · INFERRED: 260 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `71301ded`
...
Cohesion: 0.05
Nodes (29): GameWebSocketServer, Receive move and placement commands from the player and enqueue them., Receive move and placement commands from the player and enqueue them., Embedded WebSocket server that:       - Broadcasts game state to all connected o, Receive move and placement commands from the player and enqueue them., Register an observer and hold its connection open until disconnect., Register an observer and hold its connection open until disconnect., Register an observer and hold its connection open until disconnect. (+21 more)
...
Cohesion: 0.1
Nodes (15): _init_global_state(), main(), _make_engine(), parse_args(), Run n_games headless agent-vs-random games and return per-game stats.      Safe, Run n_games headless agent-vs-random games and return per-game stats.      Safe, run_game(), run_games_headless() (+7 more)

### Community 9 - "Community 9"
Cohesion: 0.08
Nodes (11): HuntAgent, Hunt-and-target agent.      Search phase: shoots only checkerboard cells (row+co, Prepend the two axis-aligned end cells to the front of the queue., Scan board for unresolved hit cells and enqueue their unshot neighbors., RandomAgent, AppLogger, GameLogger, GameLogger (+3 more)
